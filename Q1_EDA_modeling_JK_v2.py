...
#######################################################################################################################################
# Q1: How do lobbying efforts (general expenditures, indivisual lobbyist allocations) differ between policy areas in 2023?
...
# Lobby efforts
lobbyist= ['income or expenses',  'lobbyist_count_all']
...
# %%
## Sort the correlation matrix, remove the corr with themselves
